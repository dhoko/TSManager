...
abstract class HookListener {
	...
	protected function addedFiles() {
		$data = $this->grabFiles();
		TSlog('HOOK '.$data['total'].' files found from this webhook');
	...
	protected function modifiedFiles() {
		...
		TSlog('HOOK '.$data['total'].' modified files found from this webhook');
	...
	protected function removedFiles() {
		...
		TSlog('HOOK '.$data['total'].' deleted files found from this webhook');
